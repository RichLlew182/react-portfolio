    ...
    <>
      ...
      <footer className="container px-4 px-sm-0 d-flex flex-wrap justify-content-center justify-content-sm-between align-items-center py-3 my-4 mt-5 border-top">
        ...
        <ul className="nav col-sm-6 justify-content-end list-unstyled d-flex">
          ...
          <motion.li initial={{ opacity: 0, y: -40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: .3 }} className="ms-3"><a className="text-decoration-none" target="_blank" href="https://www.linkedin.com/in/richard-lee-llewellyn"><i
            className="fa-brands fa-linkedin  me-2"></i>Linkedin</a></motion.li>

          <motion.li initial={{ opacity: 0, y: -40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: .4 }} className="ms-3"><a className="text-decoration-none" target="_blank" href="./assets/files/richard-llewellyn-cv.pdf"><i className="fa-solid fa-file-lines me-2"></i>Resume</a></motion.li>
