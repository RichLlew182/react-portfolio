      ...
      <section id="intro">
        <div className="container py-0 py-sm-5 px-5 px-lg-0">
          <div className="row gx-5 d-flex flex-wrap align-items-center flex-column-reverse flex-lg-row">
            <div className="col-md-12 col-lg-6 col-xl-8 py-4  d-flex justify-content-start">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="col-md-12 col-lg-6 col-xl-4 pb-0 pt-4 py-md-4 d-flex justify-content-center">
